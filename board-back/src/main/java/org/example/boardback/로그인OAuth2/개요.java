...
* > 비밀번호 제공 없이, (네이버, 구굴, 카카오 등의) 일부 기능만 사용할 수 있는 임시 토큰을 발급해주는 방식
*
* === OAuth2 사용 흐름 ===
...
*
* 4) 서버 쪽 CustomOAuth2UserService가 코드를 AccessToken으로 교체하고
...
*   - 프론트 콜백 URL로 리다이렉트
*       http://localhost:5173/oauth2/collback?accessToken=...&refreshToken=...
*
*
